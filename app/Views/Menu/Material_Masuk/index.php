...
<body>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#detaildatamaterialmasuk"
                                            data-id="<?= $td->id_material_masuk ?>"><i
                                        ...
                                        <a class="btn btn-danger btn-sm" style="color:white"
                                            onclick="deletedatamaterialmasuk(<?= $td->id_material_masuk ?>)"><i
                                                class="bx bx-trash"></i>Hapus History</a>
                                        <?php } ?>
                                        <?php if (session()->get('jabatan') == 'PM') { ?>
                                        <<button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#detaildatamaterialmasuk"
                                            data-id="<?= $td->id_material_masuk ?>">
            ...
            <!--/ Basic Bootstrap Table -->
            <!-- Modal Detail Item material yang akan masuk -->
            <!-- Modal -->
            <div class="modal fade" id="detaildatamaterialmasuk" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Detail Material Masuk
                            </h1>
                        ...
                        <div class="modal-body">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-striped w-20 dt-responsive">
                                                ...
                                                <tbody id="isitabeldetailmaterialmasuk" class="table-border-bottom-0"
                                                    style="background-color:#D9DEE3">
                                                    <td>1</td>
                                                    <td id="nama_material"></td>
                            ...
                            <label class="foto_penerima">Foto Penerima material :</label>
