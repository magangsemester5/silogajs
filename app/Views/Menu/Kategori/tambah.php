                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" name="katnama" id="basic-icon-default-fullname" placeholder="Masukan nama kategori disini" aria-label="Masukan nama kategori disini" aria-describedby="basic-icon-default-fullname2" />
                                </div>
                            </div>
                        </div>
