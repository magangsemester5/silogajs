                    ...
                    <?php foreach ($tampildatakabel as $td) : ?>
                        <form method="POST" action="<?= base_url("edit-kabel") ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="kode_kabel_masuk" class="form-control" id="kode_kabel_masuk" value="<?= $td->kode_kabel_masuk ?>" readonly>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="basic-default-email">Nomor Drum</label>
                                <input type="text" id="basic-default-phone" value="<?= $td->nomor_drum ?>" class="form-control phone-mask" readonly />
                            </div>
                            <div class="mb-3">
                            ...
                            <br>
                            <div class="col-md-3">
                                <label>Preview Pengantaran kabel</label>
                                <img src="<?= base_url("../uploads/$td->foto_pengantaran_kabel") ?>" width="150" id="imgView" class="card-img-top img-fluid">
                            </div>
                            <br>
