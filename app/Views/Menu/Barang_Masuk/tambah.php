...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms /</span> Tambah Data Barang Masuk</h4>
        ...
        <div class="col-xl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?= base_url('prosestambah-barangmasuk') ?>" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="basic-default-fullname">Kode Barang Masuk</label>
                            <input type="text" name="kode_barang_masuk" class="form-control" readonly value="BMS<?= sprintf('%04s', $kode_barang_masuk) ?>" />
                        </div>
                        <div class="mb-3">
                        ...
                        <label class="col-md-4 text-md-right" for="jumlah_masuk">Jumlah Barang Masuk</label>
                        ...
                        <div class="mb-3">
                            ...
                            <br>
                            <div class="mb-3">
                                <label class="custom-file-label">Foto Pengantaran Barang</label>
                                <input type="file" name="foto_pengantaran_barang" id="inputFile" class="form-control" required>
                            </div>
                            <div class="col-md-3">
                            ...
                            <a href="<?= base_url('tampil-barangmasuk') ?>" class="btn btn-warning">Cancel </a>
                    </form>
                </div>
            </div>
        </div>
