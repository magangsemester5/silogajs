                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?= base_url("edit-kabel") ?>">
                        <div class="mb-3">
                            ...
                            <div class="col-md-2">
                                <input type="text" name="tanggal_keluar" class="form-control date"
                                    placeholder="Tanggal Keluar" value="<?= $td->tanggal_keluar ?>" readonly>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="basic-default-fullname">Kode kabel</label>
                            <input type="text" name="kode_kabel_keluar" class="form-control" id="kode_kabel_keluar"
                                value="<?= $td->kode_kabel_keluar ?>" readonly>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="stok" id="basic-default-phone" value="<?= $td->jumlah_keluar ?>"
                                class="form-control phone-mask" readonly />
                        </div>
                        <div class="mb-3">
