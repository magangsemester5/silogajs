            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?= base_url("prosesedit-material") ?>" enctype="multipart/form-data">
                        <input type="hidden" name="id_material" class="form-control" id="id_material"
                            value="<?php echo $tampildata->id_material ?>">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_material" class="form-control" id="basic-default-company"
                                value="<?= $tampildata->nama_material ?>" />
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="stok" id="basic-default-phone" value="<?= $tampildata->stok ?>"
