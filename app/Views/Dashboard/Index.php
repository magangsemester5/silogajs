            ...
            <div class="col-lg-12 mb-4 order-0">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title text-primary">Selamat Datang <?= session()->get('nama'); ?> (Admin Wilayah <?= session()->get('wilayah'); ?>)</h5>
                                <p class="mb-4">
            ...
            <div class="col-lg-12 mb-4 order-0">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title text-primary">Selamat Datang <?= session()->get('nama'); ?> (RPM <?= session()->get('wilayah'); ?>)</h5>
                                <p class="mb-4">
                                    di Sistem Logistik Arkatama Jaya Sakti, Semoga Sukses dan Sehat selalu
                                </p>
                            </div>
            ...
            <div class="col-lg-12 mb-4 order-0">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title text-primary">Selamat Datang <?= session()->get('nama'); ?> (Admin Pusat)</h5>
                                <p class="mb-4">
                                    di Sistem Logistik Arkatama Jaya Sakti, Semoga Sukses dan Sehat selalu
                                </p>
                            </div>
            ...
            <div class="col-lg-12 mb-4 order-0">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title text-primary">Selamat Datang <?= session()->get('nama'); ?> (Direktur)</h5>
                                <p class="mb-4">
                                    di Sistem Logistik Arkatama Jaya Sakti, Semoga Sukses dan Sehat selalu
                                </p>
                            </div>
            ...
            <div class="col-lg-12 mb-4 order-0">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title text-primary">Selamat Datang <?= session()->get('nama'); ?> (Management)</h5>
                                <p class="mb-4">
                                    di Sistem Logistik Arkatama Jaya Sakti, Semoga Sukses dan Sehat selalu
                                </p>
                            </div>
