                ...
                <form id="formAccountSettings" method="POST" action="<?= base_url("prosesedit-profil") ?>"
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="<?= base_url('') ?>/uploads/<?= session()->get('foto_user'); ?>" alt="user-avatar"
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="id_user" name="id_user"
                                    value="<?= session()->get('id_user'); ?>" placeholder="ex. Rizki Syarifudin" />
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="nama" class="form-label">Nama</label>
                                <input type="text" class="form-control" id="nama" name="nama"
                                    value="<?= session()->get('nama'); ?>" placeholder="ex. Rizki Syarifudin" />
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="no_telepon" class="form-label">Nomor Telepon</label>
                                <input class="form-control" type="text" id="no_telepon" name="no_telepon"
                                    value="<?= session()->get('no_telepon'); ?>" placeholder="ex. 081294835578" />
                            </div>
                            <input class="form-control" type="hidden" name="jabatan"
                                value="<?= session()->get('jabatan'); ?>" />
